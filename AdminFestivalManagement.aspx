<%@ Page Title="Admin Festival Management" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminFestivalManagement.aspx.cs" Inherits="Tourism_Management.AdminFestivalManagement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
    <h2>Festival List & Places</h2>
   </center>
    <div class="container">
        <div class="row">
            <div class="col-md-5">
    ...
    <div style="width: 100%; float: left;">
        <asp:Label ID="lblID" runat="server" Text="Festival ID:" />
        <asp:TextBox ID="txtID" runat="server" CssClass="form-control" OnTextChanged="txtID_TextChanged" /><br />

        <asp:Label ID="lblName" runat="server" Text="Festival Name:" />
