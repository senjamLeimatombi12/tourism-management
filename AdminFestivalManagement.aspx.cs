...
{
    public partial class AdminFestivalManagement : System.Web.UI.Page
    {
        ...
        void LoadGrid(string filter = "")
        {
            ...
            {
                string query = "SELECT * FROM admin_access_festival";
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(connStr))
            {
                try
                {
                    ...
                    SqlCommand cmd1 = new SqlCommand("SELECT COUNT(*) FROM admin_access_festival WHERE Id = @Id", con);
                    ...
                    // Insert new record
                    SqlCommand cmd = new SqlCommand("INSERT INTO admin_access_festival (Id, Name) VALUES (@Id, @Name)", con);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(connStr))
            {
                SqlCommand cmd = new SqlCommand("UPDATE admin_access_festival SET Name=@Name WHERE Id=@Id", con);
                cmd.Parameters.AddWithValue("@Id", int.Parse(txtID.Text));
                cmd.Parameters.AddWithValue("@Name", txtName.Text);
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(connStr))
            {
                SqlCommand cmd = new SqlCommand("DELETE FROM admin_access_festival WHERE Id=@Id", con);
                cmd.Parameters.AddWithValue("@Id", int.Parse(txtID.Text));
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
